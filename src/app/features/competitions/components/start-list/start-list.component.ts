...
import { EventPartition, StartListParticipant } from '../../../../shared/interfaces/interfaces';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MatTabsModule, TranslateModule, MatIconModule, LoaderSpinnerComponent, CustomTabsComponent, TimeComponent],
